...
split_fuzzy_init <- FKM(X[,1:2], k=2, maxit=10, RS=10)$U
```
...
## Splitting multi-view algorithm with fuzzy clustering
In this section, we illustrate the output of the splitting multi-view algorithm with fuzzy clustering intialization. (TODO)

## Splitting multi-view algorithm with fuzzy clustering and per-cluster weights
In this section, we illustrate the output of the splitting multi-view algorithm with fuzzy clustering intialization and per-cluster weights. (TODO)
